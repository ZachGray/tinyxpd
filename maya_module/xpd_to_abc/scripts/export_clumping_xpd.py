...
Usage:
    With the xpd_to_abc module installed, run in Maya's Script Editor:
...
# Path to the XPD to Alembic conversion tool (relative to module)
_MODULE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
XPD_TO_ABC = os.path.join(_MODULE_DIR, "bin", "xpd_to_abc.exe")
